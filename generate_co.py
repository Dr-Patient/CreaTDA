...
# 1. drug_disease
drug_disease_co = torch.Tensor(np.loadtxt(os.path.join(file_path, 'drug_disease_new.txt')))
...
# 2. drug_protein
drug_protein_co = torch.Tensor(np.loadtxt(os.path.join(file_path, 'protein_drug_new.txt'))).T
...
# 3. protein_disease
protein_disease_co = torch.Tensor(np.loadtxt(os.path.join(file_path, 'protein_disease_new.txt')))
