...
def get_args():
    ...
    parser.add_argument("--model",default = "CreaTDA", type=str, help="model type", choices=['CreaTDA_og', 'CreaTDA'])
    ...
    for i in range(args.num_steps):
        ...
        if i % 25 == 0 and verbose == True:
            ...
            if train_aupr > best_train_aupr:
                ...
                torch.save(model.state_dict(), "models/CreaTDA_{}_retrain.pth".format(args.model))
